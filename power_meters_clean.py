...
# Example usage:
folder = get_folder_path(default_folder='80Q - Power Meters - Powernet Data')  # Replace with the path to your Excel file
...
if folder:
    ...
    write_data_to_excel(METERS, 'all_power_meters_table.xlsx', month='Jul', sheet_name='Jul')